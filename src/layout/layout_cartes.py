...
class LayoutCartes:
    ...
    def register_callback(app, PATHOS_HIERARCHY):
        ...
        def set_patho_niv2_options(selected_niv1):
            ...
            # --- GARDE DE SÉCURITÉ CONTRE LE TypeError ---
            if not selected_niv1 or not isinstance(selected_niv1, str):
                # Retourne des options vides et une valeur par défaut de None
                return [], None
            # ---------------------------------------------
            ...
            if selected_niv1 in PATHOS_HIERARCHY:
                ...
                # Retourne les deux outputs (options et valeur)
                return options, default_value
            
            # Si le niv1 n'est pas trouvé
            return [], None
        ...
        def set_patho_niv3_options(selected_niv1, selected_niv2):
            ...
            # 2. CORRECTION : Ajout de la vérification str pour niv1 et niv2
